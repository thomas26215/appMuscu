...
public class AddRecupAdapter extends ArrayAdapter<PreBuilds> {
    ...
    public AddRecupAdapter(Context context, ArrayList<PreBuilds> preBuilds, AdapterCallback callBack) {
